...
system("title " + "Karma - Expiration [Lifetime]")

privatekey = input('Key : ')
if privatekey == "hoodsantoroddostool":
    pass
else:
    print('Wrong Key')
    time.sleep(5)
...
def help():
    ...
    stdout.write("             "+Fore.LIGHTMAGENTA_EX            +"║ \x1b[38;2;255;20;147m• "+Fore.LIGHTWHITE_EX+"exit     "+Fore.LIGHTMAGENTA_EX+"|"+Fore.LIGHTWHITE_EX+" Exit KARMA DDoS                        "+Fore.LIGHTMAGENTA_EX+"║\n")
    stdout.write("             "+Fore.LIGHTMAGENTA_EX            +"╠═════════════════════════════════════════════════════╣\n")
    stdout.write("             "+Fore.LIGHTMAGENTA_EX            +"║ \x1b[38;2;255;20;147m• "+Fore.LIGHTWHITE_EX+"thanks    "+Fore.LIGHTMAGENTA_EX+"|"+Fore.LIGHTWHITE_EX+" thanks for using KARMA                "+Fore.LIGHTMAGENTA_EX+"║\n")
    stdout.write("             "+Fore.LIGHTMAGENTA_EX            +"║ \x1b[38;2;255;20;147m• "+Fore.LIGHTWHITE_EX+"dev     "+Fore.LIGHTMAGENTA_EX+"  |"+Fore.LIGHTWHITE_EX+" hood#1337                    "+Fore.LIGHTMAGENTA_EX+"         ║\n")
    stdout.write("             "+Fore.LIGHTMAGENTA_EX            +"║ \x1b[38;2;255;20;147m• "+Fore.LIGHTWHITE_EX+"server   "+Fore.LIGHTMAGENTA_EX+" |"+Fore.LIGHTWHITE_EX+" discord.gg/ygwjKp6hVS       "+Fore.LIGHTMAGENTA_EX+"          ║\n")
    stdout.write("             "+Fore.LIGHTMAGENTA_EX            +"╚═════════════════════════════════════════════════════╝\n")
    stdout.write("\n")
##############################################################################################
def credit():
    stdout.write("\x1b[38;2;0;236;250m════════════════════════╗\n")
    stdout.write("\x1b[38;2;255;20;147m• "+Fore.MAGENTA   +"Developer "+Fore.RED+": \x1b[38;2;0;255;189mhood\n")
    stdout.write("\x1b[38;2;255;20;147m• "+Fore.LIGHTMAGENTA_EX   +"UI Design "+Fore.RED+": \x1b[38;2;0;255;189mSantoro\n")
    stdout.write("\x1b[38;2;255;20;147m• "+Fore.MAGENTA   +"Methods/Tools "+Fore.RED+": \x1b[38;2;0;255;189mhood\n")
    stdout.write("\x1b[38;2;0;236;250m════════════════════════╝\n")
    stdout.write("\n")    
##############################################################################################
def layer7():
    ...
    stdout.write("            "+Fore.LIGHTMAGENTA_EX            +"║ \x1b[38;2;255;20;147m• "+Fore.LIGHTWHITE_EX+"pxsky  "+Fore.LIGHTMAGENTA_EX+" |"+Fore.LIGHTWHITE_EX+" Bypass Google Project Shield, Vshield,   "+Fore.LIGHTMAGENTA_EX+"║\n")
    stdout.write("            "+Fore.LIGHTMAGENTA_EX            +"║ \x1b[38;2;255;20;147m  "+Fore.LIGHTWHITE_EX+"       "+Fore.LIGHTMAGENTA_EX+" |"+Fore.LIGHTWHITE_EX+" DDoS Guard Free, CF NoSec With Proxy     "+Fore.LIGHTMAGENTA_EX+"║\n")
...
def title():
    ...
    stdout.write("             "+Fore.LIGHTMAGENTA_EX            +"        ══╦═════════════════════════════════╦══\n")
    stdout.write("             "+Fore.LIGHTMAGENTA_EX+"╔═════════╩═════════════════════════════════╩═════════╗\n")
    stdout.write("             "+Fore.LIGHTMAGENTA_EX+"║ "+Fore.LIGHTWHITE_EX   +"        Welcome To The Main Screen Of Karma  "+Fore.LIGHTMAGENTA_EX  +"       ║\n")
    stdout.write("             "+Fore.LIGHTMAGENTA_EX+"║ "+Fore.LIGHTWHITE_EX   +"          Type [help] to see the Commands    "+Fore.LIGHTMAGENTA_EX +"       ║\n")
    stdout.write("             "+Fore.LIGHTMAGENTA_EX+"║ "+Fore.LIGHTWHITE_EX   +"         Contact Dev - Discord hood#1337   "+Fore.LIGHTMAGENTA_EX +"         ║\n")
    stdout.write("             "+Fore.LIGHTMAGENTA_EX+"╚═════════════════════════════════════════════════════╝\n")
    stdout.write("\n")
##############################################################################################
def command():
    stdout.write(Fore.LIGHTMAGENTA_EX+"╔═══"+Fore.MAGENTA+"[""root"+Fore.LIGHTGREEN_EX+"@"+Fore.LIGHTMAGENTA_EX+"Karma"+Fore.MAGENTA+"]"+Fore.LIGHTMAGENTA_EX+"\n╚══\x1b[38;2;0;255;189m> "+Fore.WHITE)
    command = input()
